...
start:
	...
	.if eax = IDYES
		invoke	MessageBox,HWND_DESKTOP,"You're correct. I am made by Pontus <3","Hello!",MB_OK
	.endif

       .if eax = IDNO
		invoke	MessageBox,HWND_DESKTOP,"You're wrong. I am made by Pontus :3","Hello!",MB_OK
	.endif
