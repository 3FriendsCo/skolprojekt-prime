...
// Logs the usage of the program
static void log_usage(char** argv, int argc) {
...
//Parser parser;
//AST_node ast_root = parser.parse(tokens);

// Handle CPP file output
// ...
...
COMPILETIME_TEST.open("GPT_async_compiletime_test.txt", std::ios::app);
